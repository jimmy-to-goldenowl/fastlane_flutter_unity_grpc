...
class DialogService {
  static final GlobalKey<NavigatorState> _dialogNavigationKey = GlobalKey<NavigatorState>();
...
/// show the dialog
Future showAlert({String? title, String? body, List<DialogButton>? actions}) async {
...
Future showCustomAlert({Widget? title, Widget? body, List<DialogButton>? actions}) async {
